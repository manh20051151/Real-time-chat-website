...
import useSendMessageImageGroup from "../hooks/useSendMessageImageGroup";

const MessageInputGroup = () => {
  const [message, setMessage] = useState("");
  const { loading, sendMessage } = useSendMessageGroup();
  const { loadingg, sendMessageImage } = useSendMessageImageGroup();
